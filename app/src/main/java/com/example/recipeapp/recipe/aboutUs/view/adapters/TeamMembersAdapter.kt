package com.example.recipeapp.recipe.aboutUs.view.adapters
...
class TeamMembersAdapter(private val members:List<TeamMember>):RecyclerView.Adapter<TeamMembersAdapter.MemberViewHolder>() {


    class MemberViewHolder(view: View):RecyclerView.ViewHolder(view){
        private val memberImg: ShapeableImageView = view.findViewById(R.id.imageView)
